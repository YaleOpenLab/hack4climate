...
function SimplePledgeVerifiedActions(props) {
  const { pledge } = props;
  return (
    <section
    ...
    >
        ...
        {!pledge.balance && (
          <>
            <p>
              ...
              no crypto-economic incentive for {pledge.pledgeOwnerName} to meet
      ...
      <article className="SimplePledge-ActionShare">
        ...
        <p>
          For this pledge to happen, everyone at {pledge.pledgeOwnerName} needs
...
export default SimplePledgeVerifiedActions;
